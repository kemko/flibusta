...
<p>
Для фото авторов и обложек к форматам, отличным от FB2, поместите lib.a.attached.zip и lib.b.attached.zip рядом с дампами в FlibustaSQL. Импорт автоматически скопирует их в cache; исходные архивы сохраняются.
Изображения распаковываются при первом обращении. В кэше хранятся фото авторов, обложки и их уменьшенные версии.</p>
